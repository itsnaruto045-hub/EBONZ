...
const pool = new pg.Pool({
  connectionString: "postgresql://neondb_owner:npg_HQtidgOWF5Z4@ep-curly-cake-a1l5cs9u-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require",
